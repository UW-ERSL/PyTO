...
from topopt_density_mma_gsa import topopt_mma_gsa
from topopt_density_oc_gsa import topopt_optimality_criteria_gsa
from topopt_pareto_gsa import topopt_pareto_gsa	
from trussopt_to_PyTO import get_3D_rho_from_2D
...
def runTOMethodOnBenchmarks(optimizationMethod):
	...
	benchmarks_2_5D_problems = [StructuralTOExamples.Mitchell_1, 
						...
						StructuralTOExamples.TwoBar,
						StructuralTOExamples.Multiload]
	benchmarks_3D_problems = [StructuralTOExamples.Multiload]
...
if __name__ == "__main__":    
	...
	optimizationMethods = [TO_METHODS.DENSITYMMA, TO_METHODS.DENSITYOC, TO_METHODS.PARETO, TO_METHODS.GSA_DENSITYOC, TO_METHODS.GSA_DENSITYMMA, TO_METHODS.GSA_PARETO]
