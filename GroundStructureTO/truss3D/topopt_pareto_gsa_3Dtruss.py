...
def topopt_pareto_gsa(fe_solver: hex_structural_fea.HexStructuralFEA,
	...
	firstIter = False
	while volfrac > to_params.DesiredVolFraction  or firstIter == False:
		firstIter = True
		if (plot_progress):
...
if __name__ == "__main__":    
	...
	import sys
	sys.path.append('../PyTO-1/Demo') #assuming the PyTO is in the parent directory
	import plots_demo
	import plots
	...
	x0 = get_3D_rho_from_2D(to_problem, fe_solver.mesh, to_params.DesiredVolFraction*1.01, use_binary_fill = True, b_plot = False)  
