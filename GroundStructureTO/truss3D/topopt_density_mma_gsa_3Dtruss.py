...
if __name__ == "__main__":    
	...
	x0 = None
	x0 = get_3D_rho_from_2D(to_problem, fe_solver.mesh, to_params.DesiredVolFraction, use_binary_fill = False, b_plot = True)  
	timeTakenget_3D_rho = time.time() - startTime
	print(f"Time taken timeTakenget_3D_rho: {timeTakenget_3D_rho:.0f} s")
