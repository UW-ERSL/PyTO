...
import numpy as np
from cyipopt import minimize_ipopt # conda install conda-forge::cyipopt

# See https://cyipopt.readthedocs.io/en/stable/tutorial.html
...
print(f"Objective: {res.fun}, Sum: {np.sum(res.x):.4f}")
